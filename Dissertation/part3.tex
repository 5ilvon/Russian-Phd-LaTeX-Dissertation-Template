...
\begin{figure}[ht]
    \centerfloat{
        ...
        \subcaptionbox{\label{fig:ifm_1g_3g3}}{%
            \includegraphics[width=0.4\linewidth]{ifm_1g_3g3.pdf}}
        \hfill
        \subcaptionbox{\label{fig:ifm_3g3_6g3}}{%
            \includegraphics[width=0.4\linewidth]{ifm_3g3_to_6g3_27C.pdf}}
        \hfill
    }

	\centerfloat{
        \hfill
        \subcaptionbox[List-of-Figures entry]{\label{fig:ifm_6g3_11g5}}{%
            \includegraphics[width=0.4\linewidth]{ifm_6g1_to_11g5_27C.pdf}}
        \hfill
        \subcaptionbox{\label{fig:ifm_11g5_18g}}{%
            \includegraphics[width=0.4\linewidth]{ifm_11g5_to_18g_27C.pdf}}
        \hfill
    }
...
\nomenclature{ВАЦ}{Векторный Анализатор Цепей}